...
scoping) and 4 (narrowing from triage entries) are done.
...
- **Ledger:** 45 tasks; phases 1 (package scaffold and the envelope records, tasks 1–3), 2
  (the corpus view, tasks 4–5), 3 (retrieval and scoping, tasks 6–11) and 4 (narrowing from
  triage entries, tasks 12–13) are done — the first implemented code in the repository.
...
- The **task phase is complete** — all four specs carry a ledger — and implementation has begun:
  `api/answer-engine` phase 5 (prompt, parser, grounding and the outcome procedure) is the next
