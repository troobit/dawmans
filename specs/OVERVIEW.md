...
**Generated:** 2026-08-15 · **Specs:** 4 · **Anchored acceptance criteria:** 409 · **ADRs:** 35 per-spec + 12 cross-cutting · **Task ledgers:** 1 of 4
...
- **Ledger:** 45 tasks over 8 phases, test-then-implement throughout, two work streams. Phase 1 —
  ...
  model and the committed extraction fixtures — and phase 4 — furniture marking, glyph repair and
  English selection — are done; 28 tasks remain.
...
- One `tasks.md` ledger, for `data/manual-corpus`, with the `prerequisites.md` naming what no task
  can do for itself. Its first four phases are implemented: the package, the shared records, both
  source stores, PDF extraction and the committed extraction fixtures, and the text-conditioning
  stages — furniture marking, glyph repair and English content selection.
